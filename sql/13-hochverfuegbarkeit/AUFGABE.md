# SQL-Übung 13: Hochverfügbarkeit
...
4. Beobachte deine eigene Verbindung bei einem Switchover. Führe diese
   ...
   - Mit dem Recht, im eigenen Cluster umzuschalten: Lies die Rollen,
     ...
     `replica`. `kubectl` läuft mit dem Kontext `awe-d-pinniped`. Das
     Umschalten selbst braucht `kubectl cnpg promote`.
   ...
   - Ohne dieses Recht: Beende deine RW-Verbindung selbst. Setze im
     ...
     `SET application_name = 'exercise13_a';`. Führe im zweiten Query Tool
     des RW-Servers aus:
